<template>
	<div class="transmitEdit">
		<div class="addshare">
			<el-form ref="form" :model="params" :rules="rules" label-width="150px">
			
				<el-form-item label="转发图:" prop="imageUpload">
					<img-upload-list :imgUpload="params.imageUpload"></img-upload-list>
				</el-form-item>	
				<p style="margin-left:3%;margin-bottom: 20px;margin-top: -10px;font-size: 12px;color: #b3b3b3;">只支持.jpg格式</p>
